...
const ExperienceCard = ({title, company, period, description, className = ""} : ExperienceCardProps) => {
    return (
        <div
            className={`${className} border min-h-120 border-gray-300 dark:border-zinc-800 rounded-xl p-6 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-sm hover:border-accent transition-colors duration-300`}
        >
